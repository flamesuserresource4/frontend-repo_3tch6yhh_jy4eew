    ...
    <section className="relative min-h-[80vh] md:min-h-[86vh] pt-24 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl py-8 md:py-16">
          <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-[#E8DCC1]/70 text-emerald-950 shadow-sm">Agensi Kreatif Digital</span>
          <h1 className="mt-4 text-4xl md:text-6xl font-extrabold tracking-tight leading-tight text-emerald-950">
            Naikkan level brand Anda dengan sentuhan 3D dan strategi sosial
          </h1>
          <p className="mt-4 md:mt-6 text-emerald-900/80 text-base md:text-lg leading-relaxed">
            Kami memadukan strategi, media buying, dan visual 3D yang imersif untuk menarik perhatian dan mendorong konversi di setiap platform.
          </p>
